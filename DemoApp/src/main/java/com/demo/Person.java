...
public class Person {
	...
	private static final List<Person> staticPerson = new ArrayList<Person>() {
		...
		{
			add (new Person("Jose Alberto Salvatierra", "Veronica Castro", true, 1));
			add (new Person("Roberto Enriqueto", "Robertina Aranda", true, 3));
			add (new Person("Peperino Pomoro", "Teresa Milanesa", false, 0));
		}
	};
